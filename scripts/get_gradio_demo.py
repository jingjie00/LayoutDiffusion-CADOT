...
def get_demo(layout_to_image_generation_fn, cfg, model_fn, noise_schedule):
    ...
    # class_names = ['small-object', 'basketball field', 'building', 'crosswalk', 'football field', 'graveyard', 'large vehicle', 'medium vehicle', 'playground', 'roundabout', 'ship', 'small vehicle', 'swimming pool', 'tennis court', 'train', 'image', 'pad']
    ...
    with gr.Blocks() as demo:
        ...
        gr.Examples(
            examples=[
                ...
                #     [1, 'train', [0.88125, 1.0, 1.0, 0.41310539841651917]],
                #     [2, 'ship', [0.8999999761581421, 0.3817663788795471, 1.0, 0.692307710647583]],
                #     [3, 'small vehicle', [0.840624988079071, 0.02083333395421505, 0.925000011920929, 0.42500001192092896]],
                #     [4, 'tennis court', [0.17812499403953552, 0.0, 1.0, 0.5916666388511658]],
                ...
                [
                    [[0, 'image', [0.0, 0.0, 1.0, 1.0]],
                     [1, 'train', [0.88125, 0.9, 0.9, 0.91310539841651917]],
                     [2, 'ship', [0.0, 0.14166666567325592, 0.1, 0.3], ],
                     [3, 'tennis court', [0.18989062309265137, 0.23635415732860565, 0.2281093835830688, 0.4176667094230652]],
                     [4, 'small vehicle', [0.38989062309265137, 0.53635415732860565, 0.6281093835830688, 0.7176667094230652]],
                     [5, 'pad', [0.0, 0.0, 0.0, 0.0]],
                     [6, 'pad', [0.0, 0.0, 0.0, 0.0]],
                     [7, 'pad', [0.0, 0.0, 0.0, 0.0]],
                     [8, 'pad', [0.0, 0.0, 0.0, 0.0]],
